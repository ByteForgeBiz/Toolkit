...
- Use `[Ignore]` for computed properties that should never touch INI files
...
| [CLI](./CLI.md) | Attribute-based CLI parsing with aliasing, typo correction, and plugin support |
