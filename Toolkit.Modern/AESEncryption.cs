...
namespace ByteForge.Toolkit
{
    ...
    internal class AESEncryption
    {
        ...
        public string Encrypt(string Data, string Key)
        {
            ...
            var ByteIn = Encoding.Unicode.GetBytes(Data);
        ...
        /// </summary>
        /// <param name="Data">The encrypted string to be decrypted.</param>
        ...
        private class VB6Random
        {
            ...
            private float Rnd()
            {
                rndSeed = (rndSeed * 0x43FD43FD + 0xC39EC3) & 0x7FFFFFFF;
                return (float)rndSeed / 0x80000000;
            }
        }
    }
}