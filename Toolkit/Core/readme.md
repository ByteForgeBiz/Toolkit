...
| Module                            | Usage                                                                   |
|-----------------------------------|-------------------------------------------------------------------------|
| [Net](../Net/readme.md)           | Consumes extracted WinSCP binaries                                      |
| [Security](../Security/readme.md) | Can encrypt credentials used by Net module                              |
| [Logging](../Logging/readme.md)   | Log extraction lifecycle (if wrapped externally)                        |
