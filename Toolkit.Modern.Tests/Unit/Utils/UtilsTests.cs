...
namespace ByteForge.Toolkit.Tests.Unit.Utils
{
    ...
    public class UtilsTests
    {
        ...
        {
            // Assert
            ByteForge.Toolkit.Utilities.Utils.arrCRLF.Should().NotBeNull();
            ByteForge.Toolkit.Utilities.Utils.arrCRLF.Length.Should().Be(2);
            ByteForge.Toolkit.Utilities.Utils.arrCRLF[0].Should().Be('\r');
            ByteForge.Toolkit.Utilities.Utils.arrCRLF[1].Should().Be('\n');
        }
        ...
        public void FormatUSPhoneNumber_ValidTenDigits_ShouldFormatCorrectly()
        {
            ...
            {
                var result = Toolkit.Utilities.Utils.FormatUSPhoneNumber(input);
        ...
        public void NullIfEmpty_NullEmptyOrWhitespace_ShouldReturnNull()
        {
            ...
            foreach (var input in invalidInputs)
            {
                var result = Toolkit.Utilities.Utils.NullIfEmpty(input);
        ...
        public void RunSync_AsyncFunction_ShouldExecuteSynchronouslyAndReturnResult()
        {
            ...
            // Act
            var result = ByteForge.Toolkit.Utilities.Utils.RunSync(asyncFunc);
        ...
        {
            // Arrange & Act & Assert
            var intResult = Toolkit.Utilities.Utils.RunSync<int>(async (ct) =>
            {
            ...
            var boolResult = Toolkit.Utilities.Utils.RunSync<bool>(async (ct) =>
            {
                await Task.Delay(1, ct);
                return true;
            });
            ...
            var dateResult = Toolkit.Utilities.Utils.RunSync<DateTime>(async (ct) =>
            {
                await Task.Delay(1, ct);
        ...
        public void RunSync_AsyncFunctionThrowsException_ShouldPropagateException()
        {
            ...
            // Act & Assert
            AssertionHelpers.AssertThrows<AggregateException>(() => Toolkit.Utilities.Utils.RunSync(asyncFunc));
        }
        ...
        public void RunSync_ImmediateCompletion_ShouldReturnResult()
        {
            ...
            // Act
            var result = Toolkit.Utilities.Utils.RunSync(asyncFunc);
        ...
        public void RunSync_Performance_ShouldHandleMultipleExecutionsQuickly()
        {
            ...
            {
                var result = Toolkit.Utilities.Utils.RunSync<int>(async (ct) =>
                {
                    await Task.Delay(1, ct);
                    return i;
                });
