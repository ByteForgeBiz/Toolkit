...
namespace ByteForge.Toolkit
{
    ...
    public static class MailUtil
    {
        ...
        public static string MailUser
        {
            get
            {
                _MailUser = _MailUser ?? Configuration.Root["Mail Server:esUser"];
        ...
        public static string MailPassword
        {
            get
            {
                _MailPassword = _MailPassword ?? Configuration.Root["Mail Server:esPass"];
        ...
        public static bool SendMail(string emailAddresses, string subject, string body, bool isHtml, string[] filesToAttach = null)
        {
            ...
            filesToAttach = filesToAttach ?? (new string[] { });
