...
namespace ByteForge.Toolkit.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = ByteForge.Toolkit.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = ByteForge.Toolkit.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)ByteForge.Toolkit.Zip.CompressionMethod.None)
                    _CompressionLevel = ByteForge.Toolkit.Zlib.CompressionLevel.None;
                else if (CompressionLevel == ByteForge.Toolkit.Zlib.CompressionLevel.None)
                    _CompressionLevel = ByteForge.Toolkit.Zlib.CompressionLevel.Default;
        ...
        public ByteForge.Toolkit.Zlib.CompressionLevel CompressionLevel
        {
            ...
            set
            {
                ...
                if (value == ByteForge.Toolkit.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == ByteForge.Toolkit.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == ByteForge.Toolkit.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) ByteForge.Toolkit.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short) ByteForge.Toolkit.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </example>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.Encryption"/>
        ...
        ///
        /// </remarks>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.ZipErrorAction"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = ByteForge.Toolkit.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new ByteForge.Toolkit.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new ByteForge.Toolkit.Zip.ZipException("The filename must be non-null and non-empty.");
...
#if NETCF
                    // workitem 6878
                    // ByteForge.Toolkit.Zip.SharedUtilities.AdjustTime_Win32ToDotNet
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                ByteForge.Toolkit.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private ByteForge.Toolkit.Zlib.CompressionLevel _CompressionLevel;
