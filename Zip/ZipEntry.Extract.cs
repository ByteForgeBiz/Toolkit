...
namespace ByteForge.Toolkit.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="ByteForge.Toolkit.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="ByteForge.Toolkit.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="ByteForge.Toolkit.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        ///   using (ByteForge.Toolkit.Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As ByteForge.Toolkit.Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public ByteForge.Toolkit.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public ByteForge.Toolkit.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal ByteForge.Toolkit.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new ByteForge.Toolkit.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        internal void CalcWinZipAesMac(Stream input)
        {
                ...
                Encryption == EncryptionAlgorithm.WinZipAes256)
            {
                ...
                else if (input is ByteForge.Toolkit.Zlib.CrcCalculatorStream)
                {
                    xxx;
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                ByteForge.Toolkit.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new ByteForge.Toolkit.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new ByteForge.Toolkit.Zlib.DeflateStream(input2, ByteForge.Toolkit.Zlib.CompressionMode.Decompress, true);
#if BZIP
                case (short)CompressionMethod.BZip2:
                    return new ByteForge.Toolkit.BZip2.BZip2InputStream(input2, true);
#endif
            }
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = ByteForge.Toolkit.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
