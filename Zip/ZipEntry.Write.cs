...
namespace ByteForge.Toolkit.Zip
{
    public partial class ZipEntry
    {
...
#if BZIP
            if (this.CompressionMethod == ByteForge.Toolkit.Zip.CompressionMethod.BZip2)
        ...
        private bool WantReadAgain()
        {
            ...
            if (CompressionLevel == ByteForge.Toolkit.Zlib.CompressionLevel.None) return false;
        ...
        private void MaybeUnsetCompressionMethodForWriting(int cycle)
        {
            ...
            if (CompressionLevel == (short)ByteForge.Toolkit.Zlib.CompressionLevel.None &&
                CompressionMethod == ByteForge.Toolkit.Zip.CompressionMethod.Deflate)
                _CompressionMethod = 0x00;
        ...
        internal void WriteHeader(Stream s, int cycle)
        {
            ...
            // LastMod
            _TimeBlob = ByteForge.Toolkit.Zip.SharedUtilities.DateTimeToPacked(LastModified);
        ...
        private Int32 FigureCrc32()
        {
            if (_crcCalculated == false)
            {
                ...
                {
                    var output = new ByteForge.Toolkit.Crc.CrcCalculatorStream(Stream.Null);
                ...
                else
                {
                    ...
                    var crc32 = new ByteForge.Toolkit.Crc.CRC32();
        ...
        private void _WriteEntryData(Stream s)
        {
            ...
            try
            {
                ...
                var output = new ByteForge.Toolkit.Crc.CrcCalculatorStream(compressor, true);
        ...
        internal void FinishOutputStream(Stream s,
                                         ...
                                         Stream encryptor,
                                         Stream compressor,
                                         ByteForge.Toolkit.Crc.CrcCalculatorStream output)
        {
            ...
            if ((compressor as ByteForge.Toolkit.Zlib.DeflateStream) != null)
                compressor.Close();
#if BZIP
            else if ((compressor as ByteForge.Toolkit.BZip2.BZip2OutputStream) != null)
                compressor.Close();
#if !NETCF
            else if ((compressor as ByteForge.Toolkit.BZip2.ParallelBZip2OutputStream) != null)
                compressor.Close();
#endif
#endif

#if !NETCF
            else if ((compressor as ByteForge.Toolkit.Zlib.ParallelDeflateOutputStream) != null)
                compressor.Close();
#endif
            ...
            if (_UncompressedSize == 0 && _CompressedSize == 0)
            {
                ...
                if (_Password != null)
                {
                    ...
                    if (Encryption != EncryptionAlgorithm.None)
                    {
                        ...
                        // workitem 10178
                        ByteForge.Toolkit.Zip.SharedUtilities.Workaround_Ladybug318918(s);
        ...
        internal void PrepOutputStream(Stream s,
                                       ...
                                       out ByteForge.Toolkit.Crc.CrcCalculatorStream output)
        {
            ...
            // Wrap a CrcCalculatorStream around that.
            // This will happen BEFORE compression (if any) as we write data out.
            output = new ByteForge.Toolkit.Crc.CrcCalculatorStream(compressor, true);
        }
        ...
        {
            if (_CompressionMethod == 0x08 && CompressionLevel != ByteForge.Toolkit.Zlib.CompressionLevel.None)
            {
#if !NETCF
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    if (_container.ParallelDeflater == null)
                    {
                        _container.ParallelDeflater =
                            new ByteForge.Toolkit.Zlib.ParallelDeflateOutputStream(s,
                                                                       CompressionLevel,
                                                                       _container.Strategy,
                                                                       true);
                    ...
                    ByteForge.Toolkit.Zlib.ParallelDeflateOutputStream o1 = _container.ParallelDeflater;
                    o1.Reset(s);
                    return o1;
                }
#endif
                var o = new ByteForge.Toolkit.Zlib.DeflateStream(s, ByteForge.Toolkit.Zlib.CompressionMode.Compress,
                                                     CompressionLevel,
                                                     true);
                if (_container.CodecBufferSize > 0)
            ...
            if (_CompressionMethod == 0x0c)
            {
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    var o1 = new ByteForge.Toolkit.BZip2.ParallelBZip2OutputStream(s, true);
                    return o1;
                }
#endif
                var o = new ByteForge.Toolkit.BZip2.BZip2OutputStream(s, true);
                return o;
            }
#endif
