...
namespace ByteForge.Toolkit.Zip
{
    ...
    ///   cref="ByteForge.Toolkit.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="ByteForge.Toolkit.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.SetCompression"/>
    public delegate ByteForge.Toolkit.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
