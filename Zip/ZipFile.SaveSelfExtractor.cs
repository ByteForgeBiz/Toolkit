...
namespace ByteForge.Toolkit.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public ByteForge.Toolkit.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "ByteForge.Toolkit.Zip.WinFormsSelfExtractorStub.resources",
                    "ByteForge.Toolkit.Zip.Forms.PasswordDialog.resources",
                    "ByteForge.Toolkit.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace ByteForge.Toolkit.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the ByteForge.Toolkit.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider
                    ...
                    // This is the list of referenced assemblies.  ByteForge.Toolkit.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("ByteForge.Toolkit.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the ByteForge.Toolkit.Zip
                        ...
                        // add the ByteForge.Toolkit.Utilities.Zip DLL as an embedded resource
