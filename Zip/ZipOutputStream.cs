...
// generating zip files.  This class does not depend on ByteForge.Toolkit.Zip.ZipFile, but rather
...
namespace ByteForge.Toolkit.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = ByteForge.Toolkit.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="ByteForge.Toolkit.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = ByteForge.Toolkit.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="ByteForge.Toolkit.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private ByteForge.Toolkit.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public ByteForge.Toolkit.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
