...
namespace ByteForge.Toolkit.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            ByteForge.Toolkit.FileSelector ff = new ByteForge.Toolkit.FileSelector(selectionCriteria,
...
namespace ByteForge.Toolkit
{
    ...
    {
        internal abstract bool Evaluate(ByteForge.Toolkit.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(ByteForge.Toolkit.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(ByteForge.Toolkit.Zip.ZipEntry entry)
        {
        ...
        public ICollection<ByteForge.Toolkit.Zip.ZipEntry> SelectEntries(ByteForge.Toolkit.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<ByteForge.Toolkit.Zip.ZipEntry>();

            foreach (ByteForge.Toolkit.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<ByteForge.Toolkit.Zip.ZipEntry> SelectEntries(ByteForge.Toolkit.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
