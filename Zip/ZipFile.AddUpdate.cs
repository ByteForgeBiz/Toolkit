...
namespace ByteForge.Toolkit.Zip
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddFile(string, string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddItem(string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddItem(string,string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.SelectEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddFile(string,string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        ///
        /// using(ByteForge.Toolkit.Zip.ZipFile zip = new ByteForge.Toolkit.Zip.ZipFile())
        /// {
        ...
        /// </remarks>
        ///
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipFile.AddEntry(string, System.IO.Stream)"/>
        /// <seealso cref="ByteForge.Toolkit.Zip.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>
