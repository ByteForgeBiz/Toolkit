...
namespace ByteForge.Toolkit.Zip
{
    ...
    using ByteForge.Toolkit.Zip.Forms;

    public partial class WinFormsSelfExtractorStub : Form
    {
        private const string DllResourceName = "ByteForge.Toolkit.Zip.dll";
        ...
        private void FixTitle()
        {
            ...
            if (foo.StartsWith("@@") && foo.EndsWith("SFX_EXE_WINDOW_TITLE"))
            {
                this.Text = String.Format("DotNetZip v{0} Self-extractor (www.codeplex.com/DotNetZip)",
                                      ByteForge.Toolkit.Zip.ZipFile.LibraryVersion.ToString());
            }
            else this.Text = foo;
        }
        ...
        {
            List<String> _ExtractActionNames = new List<string>(Enum.GetNames(typeof(ByteForge.Toolkit.Zip.ExtractExistingFileAction)));
        ...
        {
            // This is important to resolve the ByteForge.Toolkit.Zip.dll inside the extractor.
        ...
        {
            ByteForge.Toolkit.Utilities.FolderBrowserDialogEx dlg1 = new ByteForge.Toolkit.Utilities.FolderBrowserDialogEx();
        ...
        private void DoExtract(Object obj)
        {
            ...
            global::ByteForge.Toolkit.Zip.ExtractExistingFileAction WantOverwrite = (ByteForge.Toolkit.Zip.ExtractExistingFileAction) Overwrite;
            ...
            try
            {
                ...
                foreach (global::ByteForge.Toolkit.Zip.ZipEntry entry in zip)
                {
                    if (_setCancel) { extractCancelled = true; break; }
                    if (entry.Encryption == global::ByteForge.Toolkit.Zip.EncryptionAlgorithm.None)
                    {
                        try
                        {
                        ...
                        {
                            if (WantOverwrite != global::ByteForge.Toolkit.Zip.ExtractExistingFileAction.OverwriteSilently
                            ...
                            else if (WantOverwrite == global::ByteForge.Toolkit.Zip.ExtractExistingFileAction.OverwriteSilently ||
                                     ex1.Message.Contains("already exists."))
                            {
                    ...
                    else
                    {
                        ...
                        while (!done)
                        {
                            ...
                            catch (Exception ex2)
                            {
                                ...
                                if (ex2 as ByteForge.Toolkit.Zip.BadPasswordException != null)
                                {
                                    currentPassword = "";
        ...
        private ZipFile zip
        {
            ...
            {
                if (_zip == null)
                    _zip = global::ByteForge.Toolkit.Zip.ZipFile.Read(ZipStream);
                return _zip;
            }
        }
        ...
        Stream _s;
        global::ByteForge.Toolkit.Zip.ZipFile _zip;
