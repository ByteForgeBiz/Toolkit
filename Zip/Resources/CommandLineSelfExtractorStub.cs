...
namespace ByteForge.Toolkit.Zip
{
    ...
    {
        const string DllResourceName = "ByteForge.Toolkit.Zip.dll";
        ...
        //ByteForge.Toolkit.Zip.ExtractExistingFileAction Overwrite;
        int Overwrite;

        // Attention: it isn't possible, with the design of this class as it is
        // now, to have a member variable of a type from the ByteForge.Toolkit.Zip assembly.
        ...
        public int Run()
        {
            ...
            global::ByteForge.Toolkit.Zip.ExtractExistingFileAction WantOverwrite =
                (ByteForge.Toolkit.Zip.ExtractExistingFileAction) Overwrite;
            ...
            {
                // workitem 7067
                using (global::ByteForge.Toolkit.Zip.ZipFile zip = global::ByteForge.Toolkit.Zip.ZipFile.Read(a.Location))
                {
                    if (Verbose)
