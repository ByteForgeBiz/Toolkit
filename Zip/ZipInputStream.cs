...
// reading zip files.  This class does not depend on ByteForge.Toolkit.Zip.ZipFile, but rather
    ...
    public class ZipInputStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_LeftToRead == 0)
            {
                ...
                // workitem 10178
                ByteForge.Toolkit.Zip.SharedUtilities.Workaround_Ladybug318918(_inputStream);
            }
        ...
        private ByteForge.Toolkit.Crc.CrcCalculatorStream _crcStream;
