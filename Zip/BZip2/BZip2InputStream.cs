...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:ByteForge.Toolkit.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace ByteForge.Toolkit.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly ByteForge.Toolkit.Crc.CRC32 crc = new ByteForge.Toolkit.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new ByteForge.Toolkit.BZip2.BZip2InputStream(fs))
        ///       {
