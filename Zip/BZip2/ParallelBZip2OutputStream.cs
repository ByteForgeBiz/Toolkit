...
namespace ByteForge.Toolkit.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="ByteForge.Toolkit.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="ByteForge.Toolkit.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new ByteForge.Toolkit.BZip2.ParallelBZip2OutputStream(output))
        ///           {
