...
namespace ByteForge.Toolkit
{
    ...
    ///   cref="ByteForge.Toolkit.Zip.ZipFile.AddSelectedFiles(String,String)"/> method, or one of
    ///   its overloads, is called.  It's also used for the <see
    ///   cref="ByteForge.Toolkit.Zip.ZipFile.ExtractSelectedEntries(String)"/> methods.  Typically, an
