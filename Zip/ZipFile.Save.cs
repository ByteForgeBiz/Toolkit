...
namespace ByteForge.Toolkit.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="ByteForge.Toolkit.Zip.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new ByteForge.Toolkit.Zip.ZipFile())
        /// {
        ///     zip.CompressionLevel= ByteForge.Toolkit.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = ByteForge.Toolkit.Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = ByteForge.Toolkit.Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
