...
namespace ByteForge.Toolkit.Zlib
{
    ...
    ///   <c>ByteForge.Toolkit.Zlib.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new ByteForge.Toolkit.Zlib.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new ByteForge.Toolkit.Zlib.GZipStream(input, CompressionMode.Decompress, True)
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == ByteForge.Toolkit.Zlib.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == ByteForge.Toolkit.Zlib.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == ByteForge.Toolkit.Zlib.ZlibBaseStream.StreamMode.Undefined)
            {
        ...
        internal static readonly System.Text.Encoding iso8859dash1 = new ByteForge.Toolkit.Encoding.Iso8859Dash1Encoding();
#else
