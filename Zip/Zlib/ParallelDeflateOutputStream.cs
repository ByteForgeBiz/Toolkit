...
using ByteForge.Toolkit.Zlib;
using System.IO;


namespace ByteForge.Toolkit.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        ByteForge.Toolkit.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="ByteForge.Toolkit.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="ByteForge.Toolkit.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private ByteForge.Toolkit.Crc.CRC32             _runningCrc;
        ...
        private ByteForge.Toolkit.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="ByteForge.Toolkit.Zlib.DeflateStream"/>,
        ...
        ///   cref="ByteForge.Toolkit.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new ByteForge.Toolkit.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="ByteForge.Toolkit.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    ByteForge.Toolkit.Zlib.CRC32 c= new ByteForge.Toolkit.Zlib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                ByteForge.Toolkit.Crc.CRC32 crc = new ByteForge.Toolkit.Crc.CRC32();
